...
if __name__=='__main__':
    ...
    diameter=14.5         # 1ml syringe has diameter of 4.78
    ...
    volume=[80,200,80,200,80,200,80,150]   # Buffer then Standard then air  
    ...
    rate=[40,40,40,40,40,40,40,100]         # rates for each of the sequential actions
